...
*******************************
First, extract the proj1-U********.tar and put them on the element.csee.usf.edu
...
Next, upload all of the files which were extracted from the proj1-U*******.tar into the proj1 directory
